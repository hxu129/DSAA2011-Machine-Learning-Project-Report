...
\begin{abstract}
    In the field of machine learning research and its applications, tabular data is always a great focus of people where they try to develop useful frameworks to perform multiple tasks like regression and classification, which is strongly related to the intrinsic characteristics of the data. In this project, we try to explore the characteristics of the \textbf{Adult Income} dataset with visualization methods like t-SNE and explore the potential of tree based ensemble models in
    performing classification tasks on the dataset.

    In the end of the project, we then found that xxxxx.
\end{abstract}
